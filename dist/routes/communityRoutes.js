...
// Community routes
router.post('/', auth_1.authenticateToken, (0, auth_1.requireRole)(['RESEARCHER', 'ADMIN']), (0, validation_1.validateRequest)(community_1.createCommunitySchema), communityController_1.createCommunity);
